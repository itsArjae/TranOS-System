      ...
      <div className={styles.layout__box}>
        ...
        <div className={styles.layout__nav}>
          <button
            ...
            style={{ backgroundColor: dashColor ? dashColor : "transparent" }}
          >
            DASHBOARD
          </button>
          <button
            ...
            style={{ backgroundColor: empColor ? empColor : "transparent" }}
          >
            USERS
          </button>
          <button
            ...
            style={{ backgroundColor: salesColor ? salesColor : "transparent" }}
          >
            SALES
          </button>
          <button
            ...
            style={{ backgroundColor: notifColor ? notifColor : "transparent" }}
          >
            NOTIFICATION
          </button>
          <button
            style={{
              backgroundColor: logoutColor ? logoutColor : "transparent",
            }}
          >
            LOGOUT
          </button>
